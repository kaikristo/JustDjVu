...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, string[]> Translations = new(StringComparer.Ordinal)
    {
        ...
        ["Копировать выделенный текст"] = ["Copy selected text", "Ausgewählten Text kopieren", "Copier le texte sélectionné", "Copiar texto seleccionado"],
        ["Выделить весь текст"] = ["Select all text", "Gesamten Text auswählen", "Sélectionner tout le texte", "Seleccionar todo el texto"],
        ...
        ["JustDjVu 0.8.0\n\nСовременный DjVu-ридер для Windows.\nРендеринг документов: DjVuLibre 3.5.29 (GPL v2+).\n\nПоддерживает масштабирование, режимы просмотра, выделение и копирование текста, поиск OCR-текста, закладки, печать, drag & drop и «Открыть с помощью»."] = ["JustDjVu 0.8.0\n\nA modern DjVu reader for Windows.\nDocument rendering: DjVuLibre 3.5.29 (GPL v2+).\n\nSupports zoom, view modes, text selection and copying, OCR text search, bookmarks, printing, drag & drop and “Open with”.", "JustDjVu 0.8.0\n\nEin moderner DjVu-Reader für Windows.\nDokumentdarstellung: DjVuLibre 3.5.29 (GPL v2+).\n\nUnterstützt Zoom, Ansichtsmodi, Textauswahl und Kopieren, OCR-Textsuche, Lesezeichen, Drucken, Drag & Drop und „Öffnen mit“.", "JustDjVu 0.8.0\n\nUn lecteur DjVu moderne pour Windows.\nRendu des documents : DjVuLibre 3.5.29 (GPL v2+).\n\nPrend en charge le zoom, les modes d’affichage, la sélection et la copie de texte, la recherche OCR, les signets, l’impression, le glisser-déposer et « Ouvrir avec ».", "JustDjVu 0.8.0\n\nUn lector DjVu moderno para Windows.\nRenderizado: DjVuLibre 3.5.29 (GPL v2+).\n\nAdmite zoom, modos de vista, selección y copia de texto, búsqueda OCR, marcadores, impresión, arrastrar y soltar y «Abrir con»."],
